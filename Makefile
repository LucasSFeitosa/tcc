...
EDITAVEIS_SOURCES = informacoes.tex errata.tex dedicatoria.tex \
					...
					elementosdotexto.tex elementosdopostexto.tex apendices.tex anexos.tex

EDITAVEIS_FILES = $(addprefix $(EDITAVEIS_DIR)/, $(EDITAVEIS_SOURCES))

CHAPTERS_DIR = capitulos
CHAPTERS_SOURCES = 1-introducao.tex  3-referencial.tex 2-proposta.tex \
									 6-resultados.tex  7-consideracoes.tex
