...
subseção na descrição de cada exemplo de uso. Todas as atividades foram organizadas,
...
programa que é executado quando um serviço é solicitado. Neste caso, é necessário
