...
das aplicações utilizou-se uma ferramenta para auxiliar na criação das máquinas virtuais onde é
...
stretch(atualmente a versão instável) e 64 bits, apesar de a versão ser a versão
instável isso é importante para que possamos utilizar as versões mais novas dos
