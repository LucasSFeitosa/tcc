...
automatizada de aplicações, foi feito uma busca de alguns trabalhos relacionados recentes. \citeonline{leo2014} em seu mestrado,
...
suporta \citeonline{sandstormio}. Sandstorm trás aplicações prontas para uso, em que o usuário escolhe por meio de uma interface web e a aplicação já está disponível.
...
A fase exploratória foi importante para apoiar na definição das fases e procedimentos para implantação
