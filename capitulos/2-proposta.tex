...
A ferramenta JuJu utiliza uma abstração conhecida como charm,
...
virtuais, que serão os nós alvo das implantações, para que seja possível gerenciá-las 
...
com o capítulo \ref{cap-referencial}, com o acréssimo da fase de configuração de múltiplas
