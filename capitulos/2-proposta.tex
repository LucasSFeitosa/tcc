...
suporta \citeonline{sandstormio}. Sandstorm trás aplciações prontas para uso, em que o usuário escolhe por meio de uma interface web e a aplicação já está disponível.
