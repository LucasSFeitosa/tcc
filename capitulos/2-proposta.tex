...
No Shak, uma aplicação possui uma abstração exemplfiicada na figura \ref{fig:shak2},
...
a aplicação necessita, como por exemplo, o endereço da aplicação. E essas entradas
...
Em resumo, a estrutura do Shak possui os seguintes componentes:
