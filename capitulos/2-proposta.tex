...
Os trabalhos encontrados também serão insumos para auxiliar na proposta da
...
O primeiro
trabalho relacionado é um trabalho acadêmico, \citeonline{leo2014} em seu mestrado,
...
de automação de instalação de aplicações, \citeonline{bitnami} é uma 
...
\citeonline{sandstormio}  que é uma plataforma de código aberto para servidores
...
Durante Google Summer of Code 2015 \footnote{https://www.google-melange.com/gsoc/project/details/google/gsoc2015/thiagovsk/5757334940811264}, o autor deste trabalho realizou 
várias atividades relacionadas na evolução da ferramenta Shak. Tornando a ferramenta uma
...
%TODO pontunar/quebrar em 2 sentenças aqui:
...
%TODO colocar depois da primeira etapa exploratoria
