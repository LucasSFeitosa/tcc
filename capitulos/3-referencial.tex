...
configuração de rede, armazenamento de arquivos, monitoramento e segurança. Sua 
...
instalar uma aplicação pode ser necessario instalar previamente um compilador ou interpretador
