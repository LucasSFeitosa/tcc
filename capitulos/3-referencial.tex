...
Uma das grandes vantagens do uso das práticas DevOps é a automação da implantação
de software, evitando configurações manuais, uma abordagem saudável é automatizar toda
a sua infraestrutura, utilizando ferramentas que auxiliam nesse processo. Uma
prática bem conhecida é a prática denominada infraestrutura como código, 
que torna toda a infraestrutura do projeto em scripts, essencialmente como um 
...
e poder utilizar ferramentas que auxiliem a prática do DevOps de colaboração,
...
sistema de controle de verão, permitindo que outras pessoas colaborem e trabalhem em
