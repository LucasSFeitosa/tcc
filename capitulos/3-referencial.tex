...
De acordo com \cite{httermann2012DevOps} a comunidade \textit{DevOps} defende a comunicação
...
De acordo com \cite{5741269}, existem várias soluções técnicas para melhorar a implantação de software,
...
Em \cite{leo2014}, é dito que para a implantação automatizada de software é
possível utilizar linguagens de script de propósito
geral como (Python, Ruby e Shellscript), ou ferramentas gerais voltados para o processo
...
mais de uma aplicação web numa única máquina. Com a Hospedagem Virtual é possível
...
os procedimentos de segurança que devem ser tomados numa implantação, como por exemplo a criação de certificados digitais. Para entender quais são esses procedimentos, será abordado quais são
...
De acordo com \cite{kurose2010redes} o \textit{HTTP} é um protocolo da camada de aplicação
...
nenhum tipo de segurança numa rede aberta. De acordo com \cite{kurose2010redes}
